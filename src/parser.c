...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(43),
  [14] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2),
  [16] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(31),
  ...
  [35] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_extension_statement, 3),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_extension_statement, 3),
  [39] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 4),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 4),
  [43] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_extension_statement, 4),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_extension_statement, 4),
  [47] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 3),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 3),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 2),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 2),
  [55] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_extension_statement, 2),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_extension_statement, 2),
  ...
  [85] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_concatenation_repeat1, 2), SHIFT_REPEAT(15),
  [88] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_concatenation_repeat1, 2), SHIFT_REPEAT(16),
  ...
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [105] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(23),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2),
  [110] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(24),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument, 1),
  ...
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_concatenation, 2),
  ...
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_range, 1),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_yang_version, 1),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_built_in_type, 1),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean, 1),
  [141] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_concatenation_repeat1, 2),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_yang, 1),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_keyword, 1),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_submodule, 3, .production_id = 2),
  [151] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 3, .production_id = 1),
};
